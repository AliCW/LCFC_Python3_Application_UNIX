...
sch_catches = str(6)
sch_sweeps = str(7)
sch_throw_outs = str(94)
sch_goal_kicks = str(148)
sch_clean_sheets = str(8)
sch_goals_conceded = str(19)

sch_assists = str(0)#team_play
sch_passes_completed = str(418)
sch_passes_per_game = str(26)
sch_pass_accuracy = str(75)

sch_appearances = str(21)#performance_stats
sch_total_saves = str(53)
sch_saves_per_game = str(2.5)
sch_wins = str(14)
sch_draws = str(3)
sch_losses = str(4)
...
chi_appearances = str(17) #appearances
chi_goals = str(1) #goals
chi_tackles = str(22) #tackles made
chi_intercept = str(19) #interceptions made
...
soy_appearances = str(20) #appearances
soy_goals = str(1) #goals
soy_tackles = str(33) #tackles made
soy_intercept = str(29) #interceptions made
...
mor_appearances = str(6) #appearances
mor_goals = str(0) #goals
mor_tackles = str(0) #tackles made
mor_intercept = str(1) #interceptions made
...
eva_appearances = str(21) #appearances
eva_goals = str(1) #goals
eva_tackles = str(25) #tackles made
eva_intercept = str(30) #interceptions made
...
rper_appearances = str(20) #appearances
rper_goals = str(2) #goals
rper_tackles = str(83) #tackles made
rper_intercept = str(39) #interceptions made
...
fuc_appearances = str(6) #appearances
fuc_goals = str(0) #goals
fuc_tackles = str(10) #tackles made
fuc_intercept = str(8) #interceptions made
...
gra_appearances = str(13) #appearances
gra_goals = str(1) #goals
gra_passes = str(171)#passes
gra_passes_tar = str(152) #passes on target
gra_shots = str(11) #shots
gra_shots_tar = str(5) #shots on target
gra_assists = str(1) #
...
tie_appearances = str(20) #appearances
tie_goals = str(3) #goals
tie_passes = str(1054)#passes
tie_passes_tar = str(864) #passes on target
tie_shots = str(36) #shots
...
mad_appearances = str(20) #appearances
mad_goals = str(6) #goals
mad_passes = str(967)#passes
mad_passes_tar = str(813) #passes on target
mad_shots = str(50) #shots
mad_shots_tar = str(14) #shots on target
mad_assists = str(3) #
...
bar_appearances = str(19) #appearances
bar_goals = str(1) #goals
bar_passes = str(354)#passes
bar_passes_tar = str(278) #passes on target
bar_shots = str(32) #shots
...
cho_appearances = str(12) #appearances
cho_goals = str(1) #goals
cho_passes = str(287)#passes
cho_passes_tar = str(251) #passes on target
...
men_appearances = str(2) #appearances
men_goals = str(0) #goals
men_passes = str(48)#passes
men_passes_tar = str(42) #passes on target
...
ndi_appearances = str(20) #appearances
ndi_goals = str(2) #goals
ndi_passes = str(1026)#passes
ndi_passes_tar = str(865) #passes on target
ndi_shots = str(16) #shots
...
pra_appearances = str(14) #appearances
pra_goals = str(0) #goals
pra_passes = str(266)#passes
pra_passes_tar = str(228) #passes on target
pra_shots = str(7) #shots
...
var_appearances = str(19) #appearances
...
var_shots = str(49) #shots
var_shots_tar = str(29) #shots on target
var_assists = str(3) #
...
ihe_appearances = str(5) #appearances
...
ihe_shots = str(11) #shots
ihe_shots_tar = str(6) #shots on target
ihe_assists = str(2) #
...
per_appearances = str(18) #appearances
per_goals = str(5) #goals
per_left = str(1)#goals with left foot
per_right = str(4)#goals with right foot
per_headers = str(0)#goals with header
per_fkick = str(0)#goals from free kicks
per_pen = str(0)#goals from penalties
per_shots = str(26) #shots
per_shots_tar = str(14) #shots on target
per_assists = str(4) #
